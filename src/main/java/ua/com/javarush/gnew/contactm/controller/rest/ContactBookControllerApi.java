...
public class ContactBookControllerApi {
    ...
    public ContactBookControllerApi(ContactBookRepository contactBookRepository,
    ...
    @PutMapping
    public ResponseEntity<ContactBookDTO> update(@RequestParam("id") Long id,
                                                 @RequestBody ContactBookDTO contactBookDTO){
